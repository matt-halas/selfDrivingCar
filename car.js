    ...
    update(roadBorders, traffic){
        ...
        if (this.sensor){
            ...
            const offsets=this.sensor.readings.map(
                ...
                //Gets 0 when sensor doesn't detect, signal gets stronger when offset is
                //smaller i.e. closer to the car
            );
    ...
    #move(){
        ...
        if(this.speed!=0){
            ...
            if(this.controls.left){
                this.angle-=this.turningRate*flip;
            }
